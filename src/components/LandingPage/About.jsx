      ...
      <div className="about-content-wrapper">
        ...
        <div className="about-info-wrapper">
          ...
          <p className="about-info-text">
            ...
            including: excellent communuication, organization, time management,
            interpersonal relationships, patience, and being able to think on my
            toes in a fast paced environment.
          </p>
