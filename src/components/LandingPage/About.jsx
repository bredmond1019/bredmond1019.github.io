    ...
    <div id="about" className="about-section">
      ...
      <div className="about-content-wrapper">
        ...
        <div className="about-info-wrapper">
          ...
          <p className="about-info-text">
            I am a web developer with a passion for learning and teaching. I used to teach high
            school Computer Science and Mathematics for about 6 years, until the end of 2020 when I
            decided to make a change and persue a career as a Full Stack Web Developer.
          </p>
